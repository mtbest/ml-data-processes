...
newdata3 <- d %>% 
  filter(St1_pfv1_num == 1 | St1_pfv2_num == 1)
newdata4 <- d %>% 
  filter(St1_pfv1_num == 1 & St1_pfv2_num == 1)
newdata5 <- d %>% 
  filter(D_female == "female" & D_race_ML == "Black or African American")
newdata6 <- d %>%
  filter(D_female == "male" & D_race_ML == "Black or African American")
