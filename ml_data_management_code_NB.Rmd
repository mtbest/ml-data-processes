...
table <- d[c("St1_S_gen_pre", "St1_P_gen_pre", "St1_INTER_m_pre")]
...
b1<- summarySE(d, measurevar="St1_INTER_m_pre", na.rm=TRUE)
b2<- summarySE(d, measurevar="St1_mot_a_5_pre", na.rm=TRUE)
b3<- summarySE(d, measurevar="St1_mot_a_6_pre", na.rm=TRUE)
b4<- summarySE(d, measurevar="St1_mot_a_7_pre", na.rm=TRUE)
b5<- summarySE(d, measurevar="St1_mot_a_8_pre", na.rm=TRUE)
...
b0 <- map(
  ...
  .f = ~ summarySE(d, measurevar = .x, na.rm = TRUE)
  )
...
nd_data <- d[!duplicated(merged_data$PartID_pre),]
