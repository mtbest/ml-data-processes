...
table <- d[c("St1_S_gen", "St1_P_gen", "St1_INTER_m")]
...
b1<- summarySE(d, measurevar="St1_INTER_m", na.rm=TRUE)
b2<- summarySE(d, measurevar="St1_mot_a_5", na.rm=TRUE)
b3<- summarySE(d, measurevar="St1_mot_a_6", na.rm=TRUE)
b4<- summarySE(d, measurevar="St1_mot_a_7", na.rm=TRUE)
b5<- summarySE(d, measurevar="St1_mot_a_8", na.rm=TRUE)
